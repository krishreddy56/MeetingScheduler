...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_content_wrapper">
    	...
    	<div id="content">
        	...
        	<center><h3><font style="font-family: serif;color:maroon; ">You have Logged out Successfully</font></h3></center>
           <center>
           <form action="userupdation.jsp" method="post" onsubmit="return validate();">
